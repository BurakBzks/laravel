    ...
    <div class="row">
        ...
        <div class="col-10">
            ...
            <form action="{{ route('stockAdd') }}" method="post">
                @csrf
                <input type="text" name="ad" placeholder="Stok Adeti Giriniz" id="" class="form-control"> <hr>
            ...
            <table id="example" class="display" style="width:100%">
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <a href="{{ route('stockUpdate')."/".$val->id }}" class="edit btn btn-success btn-sm">GÜNCELLE</a>
                    </td>
